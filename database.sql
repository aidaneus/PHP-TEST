...
# USE test;
create table users(user_id integer not null,send_messages varchar(255) not null,service_api varchar(255) not null,debug varchar(255) not null);
...
create table groups(group_id bigint AUTO_INCREMENT primary key,name varchar(255) not null,send_messages varchar(255) not null,service_api varchar(255) not null,debug varchar(255) not null);
...
create table groups_n_users(id bigint AUTO_INCREMENT primary key,name_group varchar(255) not null,user_id integer not null);
