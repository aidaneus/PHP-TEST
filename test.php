    ...
    public function testUserInAGroup(){                     //проверка на добавление уже существующего в группе пользователя №2
       ...
       $this->assertEquals($ret, $main->engine($request,$main->connect));
        ...
        public function testShowGroup(){                            //проверка вывода групп вместе с правами
            ...
            $ret = '[{"0":"test","name":"test","user_id":[{"0":"1","user_id":"1"}]},{"0":"test2","name":"test2","user_id":[]},{"0":"test3","name":"test3","user_id":[{"0":"3","user_id":"3"}]}]';
            $this->assertEquals($ret, $main->engine($request, $main->connect));
        }
        ...
        public function testShowUsers(){                            //проверка вывода пользователей с правами
            ...
            $main = new main();
            $main->conn($main);
            $ret = '[{"0":"1","user_id":"1","rights":[{"0":"true","send_messages":"true","1":"false","service_api":"false","2":"false","debug":"false"}]},{"0":"2","user_id":"2","rights":[{"0":"false","send_messages":"false","1":"false","service_api":"false","2":"false","debug":"false"}]},{"0":"3","user_id":"3","rights":[{"0":"true","send_messages":"true","1":"true","service_api":"true","2":"true","debug":"true"}]}]';
